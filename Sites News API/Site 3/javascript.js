...
function exibeNoticia8 () {
    ...
    let texto8 = '<h3 class="p-4 mb-2 bg-white text-dark">Collaborations</h3>';
...
function exibeNoticia14 () {
    let divTela14 = document.getElementById('tela');
    let texto14= '';
...
document.getElementById ('o').addEventListener ('click', executaPesquisa14);



function exibeNoticia15 () {
    let divTela15 = document.getElementById('tela');
    let texto15= '';

    // Montar texto HTML das noticias
    let dados15 = JSON.parse (this.responseText);
    for (i=dados15.articles.length-4; i< dados15.articles.length; i++) {
        let noticia15 = dados15.articles[i];
        let datas = new Date (noticia15.publishedAt);
        ...
        texto15 = texto15 + `
            ...
            <div class="card mb-4" style="max-width: 100%;">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <a href="${noticia15.url}">
                            <img src="${noticia15.urlToImage}" class="card-img" alt="">
                        </a>
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            <a href="${noticia15.url}">
                                <h5 class="card-title">${noticia15.title}</h5>
                                <p class="card-text">${noticia15.description}</p>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    // Preencher a DIV com o texto HTML
    divTela15.innerHTML = texto15;
}

function executaPesquisa15 () {

    let xhr15 = new XMLHttpRequest ();
    xhr15.onload = exibeNoticia15;
...
document.getElementById ('p').addEventListener ('click', executaPesquisa15);
...
document.getElementById ('r').addEventListener ('click', executaPesquisa16);
...
document.getElementById ('s').addEventListener ('click', executaPesquisa17);