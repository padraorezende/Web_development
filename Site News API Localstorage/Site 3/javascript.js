...
function exibeNoticiasss () {
    ...
    let textoss = '<h3 class="p-3 mb-2 bg-white text-secondary">Companhias</h3>';
...
function exibeNoticias4 () {
    ...
    let texto4 = '<h3 class="p-4 mb-2 bg-dark text-white">Blasting News BR</h3>';
...
function exibeNoticias5 () {
    ...
    let texto5 = '<h3 class="p-4 mb-2 bg-dark text-white">Globo</h3>';
...
function exibeNoticias6 () {
    ...
    let texto6 = '<h3 class="p-4 mb-2 bg-dark text-white">Google News BR</h3>';
...
function exibeNoticias7 () {
    ...
    let texto7 = '<h3 class="p-4 mb-2 bg-dark text-white">Info Money</h3>';
...
function exibeNoticia8 () {
    ...
    let texto8 = ' <h3 class="p-3 mb-2 bg-dark text-white">Companhias</h3> ';
...
function exibeNoticias9 () {
    ...
    let texto9 = '<h3 class="p-4 mb-2 bg-dark text-white">Blasting News BR</h3>';
...
function exibeNoticias10 () {
    ...
    let texto10 = '<h3 class="p-4 mb-2 bg-dark text-white">Globo</h3>';
...
function exibeNoticias11 () {
    ...
    let texto11 = '<h3 class="p-4 mb-2 bg-dark text-white">Google News BR</h3>';
...
function exibeNoticias12 () {
    ...
    let texto12 = '<h3 class="p-4 mb-2 bg-dark text-white">Info Money</h3>';
